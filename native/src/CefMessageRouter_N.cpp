...
Java_com_techsenger_ceffx_core_browser_CefMessageRouter_1N_N_1Create(JNIEnv* env,
                                                   jclass cls,
  ...
  JNI_CALL_VOID_METHOD(
      ...
      "(Lcom/techsenger/ceffx/core/browser/CefMessageRouter$CefMessageRouterConfig;)V",
      jrouterConfig);
...
Java_com_techsenger_ceffx_core_browser_CefMessageRouter_1N_N_1Dispose(JNIEnv* env,
                                                    jobject obj,
                                                    jlong self) {
...
Java_com_techsenger_ceffx_core_browser_CefMessageRouter_1N_N_1AddHandler(JNIEnv* env,
                                                       jobject obj,
                                                       jlong self,
                                                       jobject jrouterHandler,
                                                       jboolean jfirst) {
...
JNIEXPORT jboolean JNICALL
Java_com_techsenger_ceffx_core_browser_CefMessageRouter_1N_N_1RemoveHandler(
    JNIEnv* env,
    jobject obj,
    jlong self,
    jobject jrouterHandler) {
...
JNIEXPORT void JNICALL
Java_com_techsenger_ceffx_core_browser_CefMessageRouter_1N_N_1CancelPending(
    JNIEnv* env,
    jobject obj,
    jlong self,
    jobject jbrowser,
