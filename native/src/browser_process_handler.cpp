...
bool BrowserProcessHandler::OnAlreadyRunningAppRelaunch(
  ...
  ScopedJNIObject<CefCommandLine> jcommandLine(
      env, command_line, "com/techsenger/ceffx/core/callback/CefCommandLine_N", "CefCommandLine");
  ...
  JNI_CALL_BOOLEAN_METHOD(
      ...
      "(Lcom/techsenger/ceffx/core/callback/CefCommandLine;Ljava/lang/String;)Z",
