...
#ifndef CEFFX_NATIVE_JNI_SCOPED_HELPERS_H_
#define CEFFX_NATIVE_JNI_SCOPED_HELPERS_H_
...
// --------
//
// CEFFX uses JNI bindings to support two-way communication between Java objects
...
//
// Below are examples of the common usage patterns for CEFFX bindings.
//
//
// ---------
// EXAMPLE 1
...
//   Java_com_techsenger_ceffx_core_handler_CefSomeObject_1N_N_1GetSomething(JNIEnv* env,
//                                                         jobject obj,
//                                                         jlong self) {
...
//                                          obj,
//                                          "com/techsenger/ceffx/core/handler/CefSomeObject_N",
//                                          "CefSomeObject") {}
//   };
//
...
//                         "(Lcom/techsenger/ceffx/core/handler/CefSomeObject;)V",
//                         jsomeObject.get());
//   }
//
//
...
//   Java_com_techsenger_ceffx_core_handler_CefSomeObject_1N_N_1Dispose(JNIEnv* env,
//                                                    jobject obj) {
...
//   Java_com_techsenger_ceffx_core_handler_CefSomeObject_1N_N_1Create(JNIEnv* env, jclass cls) {
...
//                     "()Lcom/techsenger/ceffx/core/handler/CefSomeHandler;", Object, jresult);
//
...
// Used by the native counterpart of CEFFX objects to hold a global JNI handle.
...
#endif  // CEFFX_NATIVE_JNI_SCOPED_HELPERS_H_
