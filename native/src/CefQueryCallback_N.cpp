...
Java_com_techsenger_ceffx_core_callback_CefQueryCallback_1N_N_1Success(JNIEnv* env,
                                                     jobject obj,
                                                     jlong self,
                                                     jstring response) {
...
JNIEXPORT void JNICALL
Java_com_techsenger_ceffx_core_callback_CefQueryCallback_1N_N_1Failure(JNIEnv* env,
                                                     jobject obj,
                                                     jlong self,
                                                     jint error_code,
