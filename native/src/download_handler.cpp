 ...
 public:
  ScopedJNIDownloadItem(JNIEnv* env, CefRefPtr<CefDownloadItem> obj)
      : ScopedJNIObject<CefDownloadItem>(env,
                                         obj,
                                         "com/techsenger/ceffx/core/callback/CefDownloadItem_N",
                                         "CefDownloadItem") {}
};
 ...
 public:
  ScopedJNIBeforeDownloadCallback(JNIEnv* env,
      ...
      : ScopedJNIObject<CefBeforeDownloadCallback>(
            env,
            obj,
            "com/techsenger/ceffx/core/callback/CefBeforeDownloadCallback_N",
 ...
 public:
  ScopedJNIDownloadItemCallback(JNIEnv* env,
      ...
      : ScopedJNIObject<CefDownloadItemCallback>(
            env,
            obj,
            "com/techsenger/ceffx/core/callback/CefDownloadItemCallback_N",
...
bool DownloadHandler::OnBeforeDownload(
  ...
  JNI_CALL_BOOLEAN_METHOD(
      ...
      "(Lcom/techsenger/ceffx/core/browser/CefBrowser;Lcom/techsenger/ceffx/core/callback/CefDownloadItem;"
      "Ljava/lang/String;Lcom/techsenger/ceffx/core/callback/CefBeforeDownloadCallback;)Z",
...
void DownloadHandler::OnDownloadUpdated(
  ...
  JNI_CALL_VOID_METHOD(
      ...
      "(Lcom/techsenger/ceffx/core/browser/CefBrowser;Lcom/techsenger/ceffx/core/callback/CefDownloadItem;"
      "Lcom/techsenger/ceffx/core/callback/CefDownloadItemCallback;)V",
