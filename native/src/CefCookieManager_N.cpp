...
CefCookie GetJNICookie(JNIEnv* env, jobject jcookie) {
  ...
  ScopedJNIClass cls(env, "com/techsenger/ceffx/core/network/CefCookie");
  if (!cls)
    return cookie;
...
Java_com_techsenger_ceffx_core_network_CefCookieManager_1N_N_1GetGlobalManager(JNIEnv* env,
                                                             jclass cls) {
  // TODO(CEFFX): Expose the callback object.
...
Java_com_techsenger_ceffx_core_network_CefCookieManager_1N_N_1Dispose(JNIEnv* env,
                                                    jobject obj,
                                                    jlong self) {
...
Java_com_techsenger_ceffx_core_network_CefCookieManager_1N_N_1VisitAllCookies(JNIEnv* env,
                                                            jobject obj,
                                                            jlong self,
                                                            jobject jvisitor) {
...
JNIEXPORT jboolean JNICALL
Java_com_techsenger_ceffx_core_network_CefCookieManager_1N_N_1VisitUrlCookies(
    JNIEnv* env,
    jobject obj,
    jlong self,
    jstring jurl,
...
JNIEXPORT jboolean JNICALL
Java_com_techsenger_ceffx_core_network_CefCookieManager_1N_N_1SetCookie(JNIEnv* env,
                                                      jobject obj,
                                                      jlong self,
                                                      jstring jurl,
                                                      jobject jcookie) {
...
JNIEXPORT jboolean JNICALL
Java_com_techsenger_ceffx_core_network_CefCookieManager_1N_N_1DeleteCookies(JNIEnv* env,
                                                          jobject obj,
                                                          jlong self,
                                                          jstring jurl,
                                                          jstring jcookieName) {
...
JNIEXPORT jboolean JNICALL
Java_com_techsenger_ceffx_core_network_CefCookieManager_1N_N_1FlushStore(JNIEnv* env,
                                                       jobject obj,
                                                       jlong self,
                                                       jobject jhandler) {
  CefRefPtr<CefCookieManager> manager = GetSelf(self);
