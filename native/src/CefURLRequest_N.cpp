...
class URLRequest : public CefTask {
 ...
 private:
  ...
  virtual void Execute() override {
    ...
    switch (mode_) {
      case REQ_CREATE:
        // TODO(CEFFX): Add the ability to specify a CefRequestContext.
...
Java_com_techsenger_ceffx_core_network_CefURLRequest_1N_N_1Create(JNIEnv* env,
                                                jobject obj,
                                                jobject jrequest,
...
JNIEXPORT void JNICALL
Java_com_techsenger_ceffx_core_network_CefURLRequest_1N_N_1Dispose(JNIEnv* env,
                                                 jobject obj,
                                                 jlong self) {
...
Java_com_techsenger_ceffx_core_network_CefURLRequest_1N_N_1GetRequestStatus(JNIEnv* env,
                                                          jobject obj,
                                                          jlong self) {
...
JNIEXPORT jobject JNICALL
Java_com_techsenger_ceffx_core_network_CefURLRequest_1N_N_1GetRequestError(JNIEnv* env,
                                                         jobject obj,
                                                         jlong self) {
  CefRefPtr<URLRequest> urlRequest = GetSelf(self);
...
JNIEXPORT jobject JNICALL
Java_com_techsenger_ceffx_core_network_CefURLRequest_1N_N_1GetResponse(JNIEnv* env,
                                                     jobject obj,
                                                     jlong self) {
  CefRefPtr<URLRequest> urlRequest = GetSelf(self);
  if (!urlRequest)
...
JNIEXPORT void JNICALL
Java_com_techsenger_ceffx_core_network_CefURLRequest_1N_N_1Cancel(JNIEnv* env,
                                                jobject obj,
                                                jlong self) {
  CefRefPtr<URLRequest> urlRequest = GetSelf(self);
  if (!urlRequest)
