...
Java_com_techsenger_ceffx_core_callback_CefPrintDialogCallback_1N_N_1Continue(
    JNIEnv* env,
    jobject obj,
    jlong self,
...
JNIEXPORT void JNICALL
Java_com_techsenger_ceffx_core_callback_CefPrintDialogCallback_1N_N_1Cancel(JNIEnv* env,
                                                          jobject obj,
                                                          jlong self) {
  CefRefPtr<CefPrintDialogCallback> callback = GetSelf(self);
  if (!callback)
