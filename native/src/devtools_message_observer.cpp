...
void DevToolsMessageObserver::OnDevToolsMethodResult(
  ...
  JNI_CALL_VOID_METHOD(
      ...
      "(Lcom/techsenger/ceffx/core/browser/CefBrowser;IZLjava/lang/String;)V", jbrowser.get(),
...
void DevToolsMessageObserver::OnDevToolsEvent(CefRefPtr<CefBrowser> browser,
  ...
  JNI_CALL_VOID_METHOD(
      ...
      "(Lcom/techsenger/ceffx/core/browser/CefBrowser;Ljava/lang/String;Ljava/lang/String;)V",
