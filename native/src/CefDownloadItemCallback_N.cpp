...
Java_com_techsenger_ceffx_core_callback_CefDownloadItemCallback_1N_N_1Cancel(JNIEnv* env,
                                                           jobject obj,
                                                           jlong self) {
...
JNIEXPORT void JNICALL
Java_com_techsenger_ceffx_core_callback_CefDownloadItemCallback_1N_N_1Pause(JNIEnv* env,
                                                          jobject obj,
                                                          jlong self) {
  CefRefPtr<CefDownloadItemCallback> callback = GetSelf(self);
  if (!callback)
...
JNIEXPORT void JNICALL
Java_com_techsenger_ceffx_core_callback_CefDownloadItemCallback_1N_N_1Resume(JNIEnv* env,
                                                           jobject obj,
                                                           jlong self) {
  CefRefPtr<CefDownloadItemCallback> callback = GetSelf(self);
  if (!callback)
...
JNIEXPORT void JNICALL
Java_com_techsenger_ceffx_core_callback_CefDownloadItemCallback_1N_N_1Dispose(JNIEnv* env,
                                                            jobject obj,
                                                            jlong self) {
  CefRefPtr<CefDownloadItemCallback> callback = GetSelf(self);
  if (!callback)
