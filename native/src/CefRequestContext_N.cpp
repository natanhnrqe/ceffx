...
Java_com_techsenger_ceffx_core_browser_CefRequestContext_1N_N_1GetGlobalContext(JNIEnv* env,
                                                              jclass cls) {
...
JNIEXPORT jobject JNICALL
Java_com_techsenger_ceffx_core_browser_CefRequestContext_1N_N_1CreateContext(JNIEnv* env,
                                                           jclass cls,
                                                           jobject jhandler) {
  ...
  // TODO(CEFFX): Expose CefRequestContextSettings.
...
Java_com_techsenger_ceffx_core_browser_CefRequestContext_1N_N_1IsGlobal(JNIEnv* env,
                                                      jobject obj) {
  CefRefPtr<CefRequestContext> context =
...
JNIEXPORT jboolean JNICALL
Java_com_techsenger_ceffx_core_browser_CefRequestContext_1N_N_1HasPreference(JNIEnv* env,
                                                           jobject obj,
                                                           jstring jname) {
  CefRefPtr<CefRequestContext> context =
      GetCefFromJNIObject<CefRequestContext>(env, obj, "CefRequestContext");
...
JNIEXPORT jobject JNICALL
Java_com_techsenger_ceffx_core_browser_CefRequestContext_1N_N_1GetPreference(JNIEnv* env,
                                                           jobject obj,
                                                           jstring jname) {
  CefRefPtr<CefRequestContext> context =
      GetCefFromJNIObject<CefRequestContext>(env, obj, "CefRequestContext");
...
JNIEXPORT jobject JNICALL
Java_com_techsenger_ceffx_core_browser_CefRequestContext_1N_N_1GetAllPreferences(
    JNIEnv* env,
    jobject obj,
...
JNIEXPORT jboolean JNICALL
Java_com_techsenger_ceffx_core_browser_CefRequestContext_1N_N_1CanSetPreference(JNIEnv* env,
                                                              jobject obj,
                                                              jstring jname) {
  CefRefPtr<CefRequestContext> context =
      GetCefFromJNIObject<CefRequestContext>(env, obj, "CefRequestContext");
...
Java_com_techsenger_ceffx_core_browser_CefRequestContext_1N_N_1SetPreference(JNIEnv* env,
                                                           jobject obj,
                                                           jstring jname,
                                                           jobject jvalue) {
...
Java_com_techsenger_ceffx_core_browser_CefRequestContext_1N_N_1CefRequestContext_1DTOR(
    JNIEnv* env,
    jobject obj) {
