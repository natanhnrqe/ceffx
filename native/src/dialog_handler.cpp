 ...
 public:
  ScopedJNIFileDialogCallback(JNIEnv* env, CefRefPtr<CefFileDialogCallback> obj)
      : ScopedJNIObject<CefFileDialogCallback>(
            env,
            obj,
            "com/techsenger/ceffx/core/callback/CefFileDialogCallback_N",
...
bool DialogHandler::OnFileDialog(
  ...
  switch (mode) {
    default:
      JNI_CASE(env, "com/techsenger/ceffx/core/handler/CefDialogHandler$FileDialogMode",
  ...
  JNI_CALL_METHOD(
      ...
      "String;Ljava/util/Vector;Ljava/util/Vector;Ljava/util/Vector;Lcom/techsenger/ceffx/core/"
