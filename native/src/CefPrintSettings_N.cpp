...
CefRange GetJNIPageRange(JNIEnv* env, jobject obj) {
  ...
  ScopedJNIClass cls(env, "com/techsenger/ceffx/core/misc/CefPageRange");
  if (!cls)
    return range;
...
Java_com_techsenger_ceffx_core_misc_CefPrintSettings_1N_N_1Create(JNIEnv* env, jclass cls) {
...
Java_com_techsenger_ceffx_core_misc_CefPrintSettings_1N_N_1Dispose(JNIEnv* env,
                                                 jobject obj,
                                                 jlong self) {
...
Java_com_techsenger_ceffx_core_misc_CefPrintSettings_1N_N_1IsValid(JNIEnv* env,
                                                 jobject obj,
                                                 jlong self) {
...
JNIEXPORT jboolean JNICALL
Java_com_techsenger_ceffx_core_misc_CefPrintSettings_1N_N_1IsReadOnly(JNIEnv* env,
                                                    jobject obj,
                                                    jlong self) {
  CefRefPtr<CefPrintSettings> settings = GetSelf(self);
  if (!settings)
...
JNIEXPORT void JNICALL
Java_com_techsenger_ceffx_core_misc_CefPrintSettings_1N_N_1SetOrientation(JNIEnv* env,
                                                        jobject obj,
                                                        jlong self,
                                                        jboolean jlandscape) {
  CefRefPtr<CefPrintSettings> settings = GetSelf(self);
...
JNIEXPORT jboolean JNICALL
Java_com_techsenger_ceffx_core_misc_CefPrintSettings_1N_N_1IsLandscape(JNIEnv* env,
                                                     jobject obj,
                                                     jlong self) {
  CefRefPtr<CefPrintSettings> settings = GetSelf(self);
  if (!settings)
...
JNIEXPORT void JNICALL
Java_com_techsenger_ceffx_core_misc_CefPrintSettings_1N_N_1SetDeviceName(JNIEnv* env,
                                                       jobject obj,
                                                       jlong self,
                                                       jstring jname) {
  CefRefPtr<CefPrintSettings> settings = GetSelf(self);
...
Java_com_techsenger_ceffx_core_misc_CefPrintSettings_1N_N_1GetDeviceName(JNIEnv* env,
                                                       jobject obj,
                                                       jlong self) {
  CefRefPtr<CefPrintSettings> settings = GetSelf(self);
  if (!settings)
...
JNIEXPORT void JNICALL
Java_com_techsenger_ceffx_core_misc_CefPrintSettings_1N_N_1SetDPI(JNIEnv* env,
                                                jobject obj,
                                                jlong self,
                                                jint jdpi) {
  CefRefPtr<CefPrintSettings> settings = GetSelf(self);
...
Java_com_techsenger_ceffx_core_misc_CefPrintSettings_1N_N_1GetDPI(JNIEnv* env,
                                                jobject obj,
                                                jlong self) {
  CefRefPtr<CefPrintSettings> settings = GetSelf(self);
  if (!settings)
...
JNIEXPORT void JNICALL
Java_com_techsenger_ceffx_core_misc_CefPrintSettings_1N_N_1SetPageRanges(JNIEnv* env,
                                                       jobject obj,
                                                       jlong self,
...
JNIEXPORT jint JNICALL
Java_com_techsenger_ceffx_core_misc_CefPrintSettings_1N_N_1GetPageRangesCount(JNIEnv* env,
                                                            jobject obj,
                                                            jlong self) {
  CefRefPtr<CefPrintSettings> settings = GetSelf(self);
  if (!settings)
...
JNIEXPORT void JNICALL
Java_com_techsenger_ceffx_core_misc_CefPrintSettings_1N_N_1GetPageRanges(JNIEnv* env,
                                                       jobject obj,
                                                       jlong self,
                                                       jobject jrangeVector) {
  CefRefPtr<CefPrintSettings> settings = GetSelf(self);
...
JNIEXPORT void JNICALL
Java_com_techsenger_ceffx_core_misc_CefPrintSettings_1N_N_1SetSelectionOnly(
    JNIEnv* env,
    jobject obj,
    jlong self,
...
JNIEXPORT jboolean JNICALL
Java_com_techsenger_ceffx_core_misc_CefPrintSettings_1N_N_1IsSelectionOnly(JNIEnv* env,
                                                         jobject obj,
                                                         jlong self) {
  CefRefPtr<CefPrintSettings> settings = GetSelf(self);
  if (!settings)
...
JNIEXPORT void JNICALL
Java_com_techsenger_ceffx_core_misc_CefPrintSettings_1N_N_1SetCollate(JNIEnv* env,
                                                    jobject obj,
                                                    jlong self,
                                                    jboolean jcollate) {
  CefRefPtr<CefPrintSettings> settings = GetSelf(self);
...
JNIEXPORT jboolean JNICALL
Java_com_techsenger_ceffx_core_misc_CefPrintSettings_1N_N_1WillCollate(JNIEnv* env,
                                                     jobject obj,
                                                     jlong self) {
  CefRefPtr<CefPrintSettings> settings = GetSelf(self);
  if (!settings)
...
JNIEXPORT void JNICALL
Java_com_techsenger_ceffx_core_misc_CefPrintSettings_1N_N_1SetColorModel(JNIEnv* env,
                                                       jobject obj,
                                                       jlong self,
  ...
  if (IsJNIEnumValue(env, jcolor_model,
                     "com/techsenger/ceffx/core/misc/CefPrintSettings$ColorModel",
                     "COLOR_MODEL_GRAY")) {
...
JNIEXPORT jobject JNICALL
Java_com_techsenger_ceffx_core_misc_CefPrintSettings_1N_N_1GetColorModel(JNIEnv* env,
                                                       jobject obj,
                                                       jlong self) {
  jobject result = GetJNIEnumValue(
      env, "com/techsenger/ceffx/core/misc/CefPrintSettings$ColorModel", "COLOR_MODEL_UNKNOWN");
  ...
  switch (settings->GetColorModel()) {
    JNI_CASE(env, "com/techsenger/ceffx/core/misc/CefPrintSettings$ColorModel", COLOR_MODEL_GRAY,
             result);
    JNI_CASE(env, "com/techsenger/ceffx/core/misc/CefPrintSettings$ColorModel", COLOR_MODEL_COLOR,
             result);
    JNI_CASE(env, "com/techsenger/ceffx/core/misc/CefPrintSettings$ColorModel", COLOR_MODEL_CMYK,
             result);
    JNI_CASE(env, "com/techsenger/ceffx/core/misc/CefPrintSettings$ColorModel", COLOR_MODEL_CMY,
             result);
    JNI_CASE(env, "com/techsenger/ceffx/core/misc/CefPrintSettings$ColorModel", COLOR_MODEL_KCMY,
             result);
    JNI_CASE(env, "com/techsenger/ceffx/core/misc/CefPrintSettings$ColorModel", COLOR_MODEL_CMY_K,
             result);
    JNI_CASE(env, "com/techsenger/ceffx/core/misc/CefPrintSettings$ColorModel", COLOR_MODEL_BLACK,
             result);
    JNI_CASE(env, "com/techsenger/ceffx/core/misc/CefPrintSettings$ColorModel",
             COLOR_MODEL_GRAYSCALE, result);
    JNI_CASE(env, "com/techsenger/ceffx/core/misc/CefPrintSettings$ColorModel", COLOR_MODEL_RGB,
             result);
    JNI_CASE(env, "com/techsenger/ceffx/core/misc/CefPrintSettings$ColorModel", COLOR_MODEL_RGB16,
             result);
    JNI_CASE(env, "com/techsenger/ceffx/core/misc/CefPrintSettings$ColorModel", COLOR_MODEL_RGBA,
             result);
    JNI_CASE(env, "com/techsenger/ceffx/core/misc/CefPrintSettings$ColorModel",
...
JNIEXPORT void JNICALL
Java_com_techsenger_ceffx_core_misc_CefPrintSettings_1N_N_1SetCopies(JNIEnv* env,
                                                   jobject obj,
                                                   jlong self,
                                                   jint jcopies) {
  CefRefPtr<CefPrintSettings> settings = GetSelf(self);
...
JNIEXPORT jint JNICALL
Java_com_techsenger_ceffx_core_misc_CefPrintSettings_1N_N_1GetCopies(JNIEnv* env,
                                                   jobject obj,
                                                   jlong self) {
  CefRefPtr<CefPrintSettings> settings = GetSelf(self);
  if (!settings)
...
JNIEXPORT void JNICALL
Java_com_techsenger_ceffx_core_misc_CefPrintSettings_1N_N_1SetDuplexMode(JNIEnv* env,
                                                       jobject obj,
                                                       jlong self,
  ...
  if (IsJNIEnumValue(env, jduplex_mode,
                     "com/techsenger/ceffx/core/misc/CefPrintSettings$DuplexMode",
                     "DUPLEX_MODE_SIMPLEX")) {
...
JNIEXPORT jobject JNICALL
Java_com_techsenger_ceffx_core_misc_CefPrintSettings_1N_N_1GetDuplexMode(JNIEnv* env,
                                                       jobject obj,
                                                       jlong self) {
  jobject result = GetJNIEnumValue(
      env, "com/techsenger/ceffx/core/misc/CefPrintSettings$DuplexMode", "DUPLEX_MODE_UNKNOWN");
  ...
  switch (settings->GetDuplexMode()) {
    JNI_CASE(env, "com/techsenger/ceffx/core/misc/CefPrintSettings$DuplexMode",
