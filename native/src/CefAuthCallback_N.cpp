...
Java_com_techsenger_ceffx_core_callback_CefAuthCallback_1N_N_1Continue(JNIEnv* env,
                                                     jobject obj,
                                                     jlong self,
                                                     jstring username,
                                                     jstring password) {
...
JNIEXPORT void JNICALL
Java_com_techsenger_ceffx_core_callback_CefAuthCallback_1N_N_1Cancel(JNIEnv* env,
                                                   jobject obj,
                                                   jlong self) {
  CefRefPtr<CefAuthCallback> callback = GetSelf(self);
  if (!callback)
