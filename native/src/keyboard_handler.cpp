...
jobject NewJNIKeyEvent(JNIEnv* env, const CefKeyEvent& event) {
  ...
  switch (event.type) {
    default:
      JNI_CASE(env, "com/techsenger/ceffx/core/handler/CefKeyboardHandler$CefKeyEvent$EventType",
  ...
  return NewJNIObject(
      env, "com/techsenger/ceffx/core/handler/CefKeyboardHandler$CefKeyEvent",
      "(Lcom/techsenger/ceffx/core/handler/CefKeyboardHandler$CefKeyEvent$EventType;IIIZCCZ)V",
...
bool KeyboardHandler::OnPreKeyEvent(CefRefPtr<CefBrowser> browser,
  ...
  JNI_CALL_METHOD(env, handle_, "onPreKeyEvent",
                  ...
                  "CefKeyboardHandler$CefKeyEvent;Lcom/techsenger/ceffx/core/misc/BoolRef;)Z",
