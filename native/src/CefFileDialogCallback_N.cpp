...
Java_com_techsenger_ceffx_core_callback_CefFileDialogCallback_1N_N_1Continue(JNIEnv* env,
                                                           jobject obj,
                                                           jlong self,
                                                           jobject jFilePaths) {
...
JNIEXPORT void JNICALL
Java_com_techsenger_ceffx_core_callback_CefFileDialogCallback_1N_N_1Cancel(JNIEnv* env,
                                                         jobject obj,
                                                         jlong self) {
  CefRefPtr<CefFileDialogCallback> callback = GetSelf(self);
  if (!callback)
