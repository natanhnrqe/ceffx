...
#ifndef CEFFX_NATIVE_JNI_UTIL_H_
#define CEFFX_NATIVE_JNI_UTIL_H_
...
// uses a custom class loader for CEFFX classes (e.g. in JavaWebStart).
...
// Retrieve the CefSize equivalent of a javafx.geometry.Dimension2D.
CefSize GetJNISize(JNIEnv* env, jobject obj);

/**
 * Retrieve the CefRect equivalent of a javafx.geometry.BoundingBox.
 */
CefRect GetJNIRect(JNIEnv* env, jobject obj);

 // Retrieve the value of a javafx.geometry.Point2D.
...
#endif  // CEFFX_NATIVE_JNI_UTIL_H_
