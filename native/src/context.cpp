...
CefSettings GetJNISettings(JNIEnv* env, jobject obj) {
  ...
  ScopedJNIClass cls(env, "com/techsenger/ceffx/core/CefSettings");
  if (!cls)
    return settings;
  ...
  GetJNIFieldBoolean(env, cls, obj, "multi_threaded_message_loop",
                       &settings.multi_threaded_message_loop);
  GetJNIFieldBoolean(env, cls, obj, "external_message_pump",
  ...
  if (GetJNIFieldObject(env, cls, obj, "log_severity", &obj_sev,
                        "Lcom/techsenger/ceffx/core/CefSettings$LogSeverity;")) {
    ScopedJNIObjectLocal severity(env, obj_sev);
    if (IsJNIEnumValue(env, severity, "com/techsenger/ceffx/core/CefSettings$LogSeverity",
                       "LOGSEVERITY_VERBOSE")) {
      settings.log_severity = LOGSEVERITY_VERBOSE;
    } else if (IsJNIEnumValue(env, severity, "com/techsenger/ceffx/core/CefSettings$LogSeverity",
                              "LOGSEVERITY_INFO")) {
  ...
  if (GetJNIFieldObject(env, cls, obj, "background_color", &obj_col,
                        "Lcom/techsenger/ceffx/core/CefSettings$ColorType;")) {
...
bool Context::Initialize(JNIEnv* env,
  ...
  // DoMessageLoopWork.
  external_message_pump_ = settings.external_message_pump;
