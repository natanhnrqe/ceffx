...
CefRefPtr<CefCookieAccessFilter> ResourceRequestHandler::GetCookieAccessFilter(
  ...
  JNI_CALL_METHOD(env, handle_, "getCookieAccessFilter",
                  ...
                  "Lcom/techsenger/ceffx/core/network/CefRequest;)"
                  "Lcom/techsenger/ceffx/core/handler/CefCookieAccessFilter;",
...
// TODO(CEFFX): Expose the |callback| parameter.
...
ResourceRequestHandler::OnBeforeResourceLoad(CefRefPtr<CefBrowser> browser,
  ...
  JNI_CALL_METHOD(env, handle_, "onBeforeResourceLoad",
                  "(Lcom/techsenger/ceffx/core/browser/CefBrowser;Lcom/techsenger/ceffx/core/browser/CefFrame;"
                  "Lcom/techsenger/ceffx/core/network/CefRequest;)Z",
...
CefRefPtr<CefResourceHandler> ResourceRequestHandler::GetResourceHandler(
  ...
  JNI_CALL_METHOD(env, handle_, "getResourceHandler",
                  "(Lcom/techsenger/ceffx/core/browser/CefBrowser;Lcom/techsenger/ceffx/core/browser/CefFrame;"
                  "Lcom/techsenger/ceffx/core/network/CefRequest;)"
                  "Lcom/techsenger/ceffx/core/handler/CefResourceHandler;",
                  Object, jresult, jbrowser.get(), jframe.get(),
                  jrequest.get());
...
void ResourceRequestHandler::OnResourceRedirect(CefRefPtr<CefBrowser> browser,
  ...
  JNI_CALL_VOID_METHOD(
      ...
      "(Lcom/techsenger/ceffx/core/browser/CefBrowser;Lcom/techsenger/ceffx/core/browser/CefFrame;Lcom/techsenger/ceffx/core/network/"
      "CefRequest;Lcom/techsenger/ceffx/core/network/CefResponse;Lcom/techsenger/ceffx/core/misc/"
      "StringRef;)V",
...
bool ResourceRequestHandler::OnResourceResponse(
  ...
  JNI_CALL_METHOD(env, handle_, "onResourceResponse",
                  "(Lcom/techsenger/ceffx/core/browser/CefBrowser;Lcom/techsenger/ceffx/core/browser/CefFrame;"
                  "Lcom/techsenger/ceffx/core/network/CefRequest;Lcom/techsenger/ceffx/core/network/CefResponse;)Z",
...
void ResourceRequestHandler::OnResourceLoadComplete(
  ...
  JNI_CALL_VOID_METHOD(
      ...
      "(Lcom/techsenger/ceffx/core/browser/CefBrowser;Lcom/techsenger/ceffx/core/browser/CefFrame;"
      "Lcom/techsenger/ceffx/core/network/CefRequest;Lcom/techsenger/ceffx/core/network/CefResponse;"
      "Lcom/techsenger/ceffx/core/network/CefURLRequest$Status;J)V",
      jbrowser.get(), jframe.get(), jrequest.get(), jresponse.get(),
...
void ResourceRequestHandler::OnProtocolExecution(CefRefPtr<CefBrowser> browser,
  ...
  JNI_CALL_VOID_METHOD(
      ...
      "(Lcom/techsenger/ceffx/core/browser/CefBrowser;Lcom/techsenger/ceffx/core/browser/CefFrame;Lcom/techsenger/ceffx/core/network/"
      "CefRequest;Lcom/techsenger/ceffx/core/misc/BoolRef;)V",
