...
JNIEXPORT jboolean JNICALL Java_com_techsenger_ceffx_core_CefApp_N_1PreInitialize(JNIEnv* env,
                                                                jobject c) {
...
Java_com_techsenger_ceffx_core_CefApp_N_1Initialize(JNIEnv* env,
                                  jobject c,
                                  jobject appHandler,
                                  jobject jsettings) {
...
JNIEXPORT void JNICALL Java_com_techsenger_ceffx_core_CefApp_N_1Shutdown(JNIEnv* env, jobject) {
  Context::GetInstance()->Shutdown();
  Context::Destroy();
}

JNIEXPORT void JNICALL Java_com_techsenger_ceffx_core_CefApp_N_1DoMessageLoopWork(JNIEnv* env,
                                                                jobject) {
  Context::GetInstance()->DoMessageLoopWork();
}

JNIEXPORT jobject JNICALL Java_com_techsenger_ceffx_core_CefApp_N_1GetVersion(JNIEnv* env,
                                                            jobject obj) {
  return NewJNIObject(env, "com/techsenger/ceffx/core/CefApp$CefVersion",
                      "(Lcom/techsenger/ceffx/core/CefApp;IIIIIIIII)V", obj, CEFFX_COMMIT_NUMBER,
...
JNIEXPORT jboolean JNICALL
Java_com_techsenger_ceffx_core_CefApp_N_1RegisterSchemeHandlerFactory(JNIEnv* env,
                                                    jobject,
                                                    jstring jSchemeName,
                                                    jstring jDomainName,
                                                    jobject jFactory) {
...
JNIEXPORT jboolean JNICALL
Java_com_techsenger_ceffx_core_CefApp_N_1Startup(JNIEnv* env,
                               jclass,
