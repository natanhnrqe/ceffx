 ...
 public:
  ScopedJNIPrintDialogCallback(JNIEnv* env,
      ...
      : ScopedJNIObject<CefPrintDialogCallback>(
            env,
            obj,
            "com/techsenger/ceffx/core/callback/CefPrintDialogCallback_N",
 ...
 public:
  ScopedJNIPrintJobCallback(JNIEnv* env, CefRefPtr<CefPrintJobCallback> obj)
      : ScopedJNIObject<CefPrintJobCallback>(
            env,
            obj,
            "com/techsenger/ceffx/core/callback/CefPrintJobCallback_N",
            "CefPrintJobCallback") {}
};
...
void PrintHandler::OnPrintSettings(CefRefPtr<CefBrowser> browser,
  ...
  JNI_CALL_VOID_METHOD(
      ...
      "(Lcom/techsenger/ceffx/core/browser/CefBrowser;Lcom/techsenger/ceffx/core/misc/CefPrintSettings;Z)V",
...
bool PrintHandler::OnPrintDialog(CefRefPtr<CefBrowser> browser,
  ...
  JNI_CALL_METHOD(env, handle_, "onPrintDialog",
                  "(Lcom/techsenger/ceffx/core/browser/CefBrowser;ZLcom/techsenger/ceffx/core/callback/"
...
bool PrintHandler::OnPrintJob(CefRefPtr<CefBrowser> browser,
  ...
  JNI_CALL_METHOD(
      ...
      "(Lcom/techsenger/ceffx/core/browser/CefBrowser;Ljava/lang/String;Ljava/lang/String;"
      "Lcom/techsenger/ceffx/core/callback/CefPrintJobCallback;)Z",
...
CefSize PrintHandler::GetPdfPaperSize(CefRefPtr<CefBrowser> browser,
  ...
  JNI_CALL_METHOD(
      ...
      handle_,
      "getPdfPaperSize",
      "(Lcom/techsenger/ceffx/core/browser/CefBrowser;I)Ljavafx/geometry/Dimension2D;",
      Object,
      jresult,
      jbrowser.get(),
      (jint)device_units_per_inch);
