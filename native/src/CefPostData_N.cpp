...
Java_com_techsenger_ceffx_core_network_CefPostData_1N_N_1Create(JNIEnv* env, jclass cls) {
...
Java_com_techsenger_ceffx_core_network_CefPostData_1N_N_1Dispose(JNIEnv* env,
                                               jobject obj,
                                               jlong self) {
...
Java_com_techsenger_ceffx_core_network_CefPostData_1N_N_1IsReadOnly(JNIEnv* env,
                                                  jobject obj,
                                                  jlong self) {
...
Java_com_techsenger_ceffx_core_network_CefPostData_1N_N_1GetElementCount(JNIEnv* env,
                                                       jobject obj,
                                                       jlong self) {
  CefRefPtr<CefPostData> postData = GetSelf(self);
  if (!postData)
...
JNIEXPORT void JNICALL
Java_com_techsenger_ceffx_core_network_CefPostData_1N_N_1GetElements(JNIEnv* env,
                                                   jobject obj,
                                                   jlong self,
                                                   jobject jelements) {
  CefRefPtr<CefPostData> postData = GetSelf(self);
...
JNIEXPORT jboolean JNICALL
Java_com_techsenger_ceffx_core_network_CefPostData_1N_N_1RemoveElement(JNIEnv* env,
                                                     jobject obj,
                                                     jlong self,
                                                     jobject jelement) {
  CefRefPtr<CefPostData> postData = GetSelf(self);
...
JNIEXPORT jboolean JNICALL
Java_com_techsenger_ceffx_core_network_CefPostData_1N_N_1AddElement(JNIEnv* env,
                                                  jobject obj,
                                                  jlong self,
                                                  jobject jelement) {
  CefRefPtr<CefPostData> postData = GetSelf(self);
...
JNIEXPORT void JNICALL
Java_com_techsenger_ceffx_core_network_CefPostData_1N_N_1RemoveElements(JNIEnv* env,
                                                      jobject obj,
                                                      jlong self) {
  CefRefPtr<CefPostData> postData = GetSelf(self);
  if (!postData)
