...
bool ResourceHandler::ProcessRequest(CefRefPtr<CefRequest> request,
  ...
  JNI_CALL_METHOD(
      ...
      "(Lcom/techsenger/ceffx/core/network/CefRequest;Lcom/techsenger/ceffx/core/callback/CefCallback;)Z", Boolean,
...
bool ResourceHandler::Open(CefRefPtr<CefRequest> request,
  ...
  JNI_CALL_METHOD(env, handle_, "open",
                  "(Lcom/techsenger/ceffx/core/network/CefRequest;Lcom/techsenger/ceffx/core/misc/BoolRef;Lcom/techsenger/ceffx/core/"
...
void ResourceHandler::GetResponseHeaders(CefRefPtr<CefResponse> response,
  ...
  JNI_CALL_VOID_METHOD(env, handle_, "getResponseHeaders",
                       "(Lcom/techsenger/ceffx/core/network/CefResponse;Lcom/techsenger/ceffx/core/misc/"
                       "IntRef;Lcom/techsenger/ceffx/core/misc/StringRef;)V",
...
bool ResourceHandler::ReadResponse(void* data_out,
  ...
  JNI_CALL_METHOD(env, handle_, "readResponse",
                  "([BILcom/techsenger/ceffx/core/misc/IntRef;Lcom/techsenger/ceffx/core/callback/CefCallback;)Z",
...
bool ResourceHandler::Read(void* data_out,
  ...
  JNI_CALL_METHOD(
      env, handle_, "read",
      "([BILcom/techsenger/ceffx/core/misc/IntRef;Lcom/techsenger/ceffx/core/callback/CefResourceReadCallback;)Z",
      Boolean, jresult, jbytes, bytes_to_read, jbytesRead.get(),
      jcallback.get());
...
bool ResourceHandler::Skip(int64_t bytes_to_skip,
  ...
  JNI_CALL_METHOD(
      env, handle_, "skip",
      "(JLcom/techsenger/ceffx/core/misc/LongRef;Lcom/techsenger/ceffx/core/callback/CefResourceSkipCallback;)Z",
