 ...
 public:
  ScopedJNIJSDialogCallback(JNIEnv* env, CefRefPtr<CefJSDialogCallback> obj)
      : ScopedJNIObject<CefJSDialogCallback>(
            env,
            obj,
            "com/techsenger/ceffx/core/callback/CefJSDialogCallback_N",
            "CefJSDialogCallback") {}
};
...
bool JSDialogHandler::OnJSDialog(CefRefPtr<CefBrowser> browser,
  ...
  switch (dialog_type) {
    default:
      JNI_CASE(env, "com/techsenger/ceffx/core/handler/CefJSDialogHandler$JSDialogType",
  ...
  JNI_CALL_METHOD(
      ...
      "(Lcom/techsenger/ceffx/core/browser/CefBrowser;Ljava/lang/String;"
      "Lcom/techsenger/ceffx/core/handler/CefJSDialogHandler$JSDialogType;Ljava/lang/String;"
      "Ljava/lang/String;Lcom/techsenger/ceffx/core/callback/CefJSDialogCallback;Lcom/techsenger/ceffx/core/misc/"
      "BoolRef;)Z",
...
bool JSDialogHandler::OnBeforeUnloadDialog(
  ...
  JNI_CALL_METHOD(env, handle_, "onBeforeUnloadDialog",
                  "(Lcom/techsenger/ceffx/core/browser/CefBrowser;Ljava/lang/String;ZLcom/techsenger/ceffx/core/"
