...
package com.techsenger.ceffx.core.network;

import com.techsenger.ceffx.core.callback.CefCompletionCallback;
import com.techsenger.ceffx.core.callback.CefCookieVisitor;
...
public abstract class CefCookieManager {
     ...
     * creation date.
     * @param visitor Callback that will receive cookies on the CEF main thread.
     ...
     * @param handler Callback that will be executed on the CEF main thread upon completion.
     * @return False if cookies cannot be accessed.
     */
