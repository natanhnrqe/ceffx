...
import com.techsenger.ceffx.core.CefApp.CefAppState;
import com.techsenger.ceffx.core.callback.CefCommandLine;
import com.techsenger.ceffx.core.callback.CefSchemeRegistrar;
...
public interface CefAppHandler {
    ...
    /**
     * Called on the browser process CEF main thread immediately after the CEF context
