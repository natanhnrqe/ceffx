...
import com.techsenger.ceffx.core.browser.CefPaintEvent;
import com.techsenger.ceffx.core.browser.CefRendererFX;
import com.techsenger.ceffx.core.browser.CefRendererFactory;
import com.techsenger.ceffx.core.browser.CefRequestContext;
...
import com.techsenger.ceffx.core.callback.CefContextMenuParams;
...
import com.techsenger.ceffx.core.callback.CefFileDialogCallback;
import com.techsenger.ceffx.core.callback.CefJSDialogCallback;
import com.techsenger.ceffx.core.callback.CefMenuModel;
...
import com.techsenger.ceffx.core.handler.CefContextMenuHandler;
import com.techsenger.ceffx.core.handler.CefDialogHandler;
import com.techsenger.ceffx.core.handler.CefDisplayHandler;
import com.techsenger.ceffx.core.handler.CefDownloadHandler;
import com.techsenger.ceffx.core.handler.CefDragHandler;
import com.techsenger.ceffx.core.handler.CefFocusHandler;
import com.techsenger.ceffx.core.handler.CefJSDialogHandler;
import com.techsenger.ceffx.core.handler.CefKeyboardHandler;
import com.techsenger.ceffx.core.handler.CefLifeSpanHandler;
import com.techsenger.ceffx.core.handler.CefLoadHandler;
import com.techsenger.ceffx.core.handler.CefPrintHandler;
...
public class CefClient extends CefClientHandler
    ...
    public CefRendererFactory getRendererFactory() {
        return rendererFactory;
    }

    public void setRendererFactory(CefRendererFactory rendererFactory) {
...
//                        propertyChangeListener);
    ...
    public BoundingBox getViewRect(CefBrowser browser) {
        if (browser == null) return new BoundingBox(0, 0, 0, 0);
    ...
    public Point2D getScreenPoint(CefBrowser browser, Point2D viewPoint) {
        if (browser == null) return new Point2D(0, 0);
