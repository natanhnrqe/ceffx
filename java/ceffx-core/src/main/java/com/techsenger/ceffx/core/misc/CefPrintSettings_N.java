...
class CefPrintSettings_N extends CefPrintSettings implements CefNative {
    ...
    @Override
    public void setPrinterPrintableArea(Dimension2D physical_size_device_units,
            BoundingBox printable_area_device_units, boolean landscape_needs_flip) {
        try {
    ...
    private final native void N_SetPrinterPrintableArea(long self,
            Dimension2D physical_size_device_units, BoundingBox printable_area_device_units,
