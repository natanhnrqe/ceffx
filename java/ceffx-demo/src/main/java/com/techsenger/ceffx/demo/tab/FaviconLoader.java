...
final class FaviconLoader {
    ...
    public static Image loadIco(String icoUrl) {
        try {
            ...
            try (ImageInputStream input = createImageInputStream(new ByteArrayInputStream(data))) {
    ...
    private static Image bufferedToFxImage(java.awt.image.BufferedImage buffered) {
        try {
